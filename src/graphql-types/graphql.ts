...
export type GetMyConversationsQuery = { __typename?: 'Query', myConversations: Array<{ __typename?: 'Conversation', conversation_id: string, type?: string | null, created_at: string, last_read_message_id?: string | null, last_message_id?: string | null, last_message?: string | null, last_message_at?: string | null, other_user_id: string, username: string }> };
